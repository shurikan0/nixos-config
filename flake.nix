{
  description = "Flake of Shurikan's NixOS configuration 
  currently forked from Phoenix's NixOS configuration";
  ...
  outputs = inputs@{ self, ... }:
    let
      ...
      # ----- USER SETTINGS ----- #
      userSettings = rec {
        username = "shurikan"; # username
        name = "jan"; # name/identifier
        email = "jan-gruhnert@startmail.com"; # email (used for certain configurations)
        ...
        spawnBrowser = "brave"; # Default browser spawning translator
